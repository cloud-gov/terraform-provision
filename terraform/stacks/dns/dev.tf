...
module "dev_dns" {
  ...
  diego_api_bbs_lb_dns_name            = data.terraform_remote_state.development.outputs.diego_api_bbs_lb_dns_name
  ...
  platform_alerts_ses_dkim_attribute_tokens = lookup(data.terraform_remote_state.development.outputs, "platform_alerts_ses_dkim_attribute_tokens", [])

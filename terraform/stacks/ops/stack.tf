...
module "stack" {
  ...
  credhub_rds_db_engine_version             = var.rds_db_engine_version
  credhub_rds_parameter_group_family        = var.rds_parameter_group_family
  rds_shared_preload_libraries_bosh_credhub = var.rds_shared_preload_libraries
  rds_pgaudit_log_values_bosh_credhub       = var.rds_pgaudit_log_values
  rds_shared_preload_libraries_bosh         = var.rds_shared_preload_libraries
...
module "concourse" {
  ...
  rds_parameter_group_name        = "concourse-${var.stack_description}"
  rds_parameter_group_family      = var.rds_parameter_group_family
  rds_db_engine_version           = var.rds_db_engine_version
  rds_apply_immediately           = var.rds_apply_immediately
  rds_allow_major_version_upgrade = var.rds_allow_major_version_upgrade

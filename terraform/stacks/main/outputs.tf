...
output "cf_router_target_groups" {
  value = concat(
    ...
    [module.cf.lb_gorouter_target_https_group],
    [module.cf.apps_lb_gorouter_target_https_group],
...
output "cf_gorouter_target_group" {
  value = module.cf.lb_gorouter_target_https_group
}

output "cf_apps_gorouter_target_group" {
  value = module.cf.apps_lb_gorouter_target_https_group
}

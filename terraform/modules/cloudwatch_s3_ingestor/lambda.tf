...
data "http" "lambda_python" {
  url = "https://raw.githubusercontent.com/cloud-gov/aws_metrics_opensearch_preprocessor/refs/heads/lambda-pipeline/lambda_functions/transform_cloudwatch_lambda.py"
}
